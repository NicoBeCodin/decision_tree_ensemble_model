...
public:
     ...
     * @return Vecteur des prédictions pour chaque échantillon
     */
    std::vector<double> predict(const std::vector<double>& X, int rowLength) const;
     ...
     * @return Erreur quadratique moyenne (MSE)
     */
    double evaluate(const std::vector<double>& X_test, int rowLength, const std::vector<double>& y_test) const;
